...
const PageNumber = ( {pageNumber, setPageNumber} ) => {
  ...
  return (
    <div className="d-flex flex-row justify-content-center align-items-center p-2" style={{gap:"2rem"}}>
        ...
        <img style={{width:"3rem", cursor:"pointer"}} src={nexticon} alt="" onClick={()=> pageNumber>0 && pageNumber<500 ? setPageNumber(pageNumber+1) : setPageNumber(1)}/>
    </div>
  )
}
